...
- (void)testThatItSetsNotUploadedAssetClientMessagesToFailedAndAlsoExpiresFailedImageMessages_42_11
{
    ...
    ZMAssetClientMessage *uploadedFileMessage = [conversation appendMessageWithFileAtURL:self.testVideoFileURL thumbnail:self.verySmallJPEGData];
    ...
    ZMAssetClientMessage *notUploadedFileMessage = [conversation appendMessageWithFileAtURL:self.testVideoFileURL thumbnail:self.verySmallJPEGData];
