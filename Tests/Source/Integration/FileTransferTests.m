...
- (void)testThatItSendsAFileMessage
{
    ...
    [self.userSession performChanges:^{
        fileMessage = [conversation appendMessageWithFileAtURL:fileURL thumbnail:nil];
    }];
    WaitForAllGroupsToBeEmpty(0.5);
...
- (void)testThatItSendsAFileMessage_WithVideo
{
    ...
    __block ZMMessage *fileMessage;
    [self.userSession performChanges:^{
        fileMessage = [conversation appendMessageWithFileAtURL:fileURL thumbnail:self.mediumJPEGData];
    }];
    WaitForAllGroupsToBeEmpty(0.5);
...
- (void)testThatItSendsARegularFileMessageForAFileWithVideoButNilThumbnail
{
    ...
    __block ZMMessage *fileMessage;
    [self.userSession performChanges:^{
        fileMessage = [conversation appendMessageWithFileAtURL:fileURL thumbnail:nil]; // But no thumbnail
    }];
    WaitForAllGroupsToBeEmpty(0.5);
