...
- (void)testThatItCreatesVideoAddNotificationsCorrectly
{
    ...
    //    "push.notification.add.video.group" = "%1$@ shared a file in %2$@";
    //    "push.notification.add.video.group.nousername" = "New file in %1$@";
    //    "push.notification.add.video.group.nousername.noconversationname" = "New file in a conversation";
    //    "push.notification.add.video.group.noconversationname" = "%1$@ shared a file in a conversation";
    //
    //    "push.notification.add.video.oneonone" = "%1$@ shared a file";
    //    "push.notification.add.video.oneonone.nousername" = "New file in a conversation";
    //
